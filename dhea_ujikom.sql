...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2023 at 05:33 AM
...
(1, 'a', 'a', 'a', 1),
(8987, 'salsa', 'kania', '0000', 9876567),
(29765, 'shalsa', 'dea', '789', 89765356),
(76567, 'shalsa', 'dea', '', 897865),
(171819, 'kania', 'novi', '1111', 897865677),
(987656, 'fatih', 'risa', '0000', 98765),
...
(29, '2023-02-27', 987656, 'motor di begal', '', 'selesai');
...
--
ALTER TABLE `pengaduan`
  MODIFY `id_pengaduan` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
